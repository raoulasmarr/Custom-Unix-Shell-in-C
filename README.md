...
3.	Parse the line into a command structure

5.	Execute built-in commands directly in the shell process
6.	Fork and execute external commands in a child process
7.	Wait for the child to finish and clean up memory
8.  Repeat
